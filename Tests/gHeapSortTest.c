...
// Compilation Command: gcc gHeapSortTest.c ../genSorters.c -o executableProgram -I ../ -O
...
int main(int argc, char** argv) {
    ...
    */
    ...
    gHeapSort(compareFIntegers, random_numbers, (uint64_t)ARRAY_SIZE, (uint64_t)sizeof(int));
    ...
    */
    ...
    benchmarkInitialTime = clock();
    gHeapSort(compareFPerson, personArray, (uint64_t)ARRAY_SIZE, (uint64_t)(sizeof(Person)));
    benchmarkEndTime = clock();
    ...
    */
    ...
    puts("\n( Trust me bro, it's sorted... You don't want to see 10k array items in your terminal, do you...? ;) )");
